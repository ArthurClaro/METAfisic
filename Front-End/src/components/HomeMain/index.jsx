...
import BeforeLoader from '../Pré-Loader';

function HomeMain() {
    const { dataLoad, loading, toastSuccess, groups, clickGoOut, isOpen2, visibleModal, setVisibleModal } = useProductsContext()
                        ...
                        <>
                            <main className={styles.container}>
                                ...
                                <section id='sec1' className={`${styles.sec1} section `}>
                                    ...
                                    <div className="animate__animated animate__rollIn   modalFixed">
                                ...
                                <section id='groups' className={styles.sec2}>
                                    <h1 data-aos="fade-left" className='singUp'>Exercícios Musculares</h1>
                                    <ul >
                                        {groups.map(group => {
                                            return <li key={group.id}>
                                                <Link data-aos="flip-right" onClick={() => {
                                                    upMain()
                                ...
                                <section id='contact' className={styles.sec4}>
                                    ...
                                    <form data-aos="zoom-in-right" className={styles.formIndex} ref={form} onSubmit={sendEmail}>
                                        <p>Contato / Suporte</p>
